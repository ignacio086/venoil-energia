  ...
  return (
    <div className="w-screen h-screen flex flex-col-reverse lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 h-full p-12 flex gap-2 flex-col justify-center text-center items-center lg:items-end">
        <h1 className="text-verde text-xl lg:text-6xl">
          {language == "en" ? "Managment" : "Gestión"}
        </h1>
        <h1 className="text-verde text-xl lg:text-6xl" style={popt.style}>
          {language == "en" ? "Integrated" : "Integrada"}
        </h1>
        <p className="text-sm text-center lg:text-right text-white lg:text-xl">
          {language == "en"
            ? "At Venoil Energía, we focus every day on operational excellence, for this, we have an Integrated Management System."
            : "En Venoil Energía, nos enfocamos cada día en la excelencia operacional, para ello, contamos con un Sistema de Gestión Integrada."}
        </p>
        <div className="flex w-72 h-72 items-center justify-center flex-col gap-2">
          <div className=" h-24 w-12 border-2 border-white flex items-center justify-center rounded-full">
          <div className="w-8 h-8 flex items-center justify-center rounded-full">
            <div className="w-6 h-6 bg-verde rounded-full"></div>
          </div>
          </div>
          <div className="w-1 h-48 bg-white"></div>
          <div
            className={`rounded-xl bg-[url("/iso.png")] bg-contain aspect-square w-1/2 h-full flex items-end justify-center flex-col bg-no-repeat bg-center`}
          ></div>
        </div>
      </div>
    </div>
